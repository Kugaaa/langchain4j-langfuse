...
public class OptionalObservationBody {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.traceId, optionalObservationBody.traceId) &&
        ...
        Objects.equals(this.version, optionalObservationBody.version)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(traceId, name, startTime, metadata, input, output, level, statusMessage, parentObservationId, version, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OptionalObservationBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptionalObservationBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
