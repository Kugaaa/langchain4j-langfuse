...
public class CreateGenerationBody {
  ...
  public CreateGenerationBody completionStartTime(OffsetDateTime completionStartTime) {
  ...
  public CreateGenerationBody model(String model) {
    this.model = model;
    return this;
  }
  ...
  public CreateGenerationBody modelParameters(Map<String, MapValue> modelParameters) {
    this.modelParameters = modelParameters;
    return this;
  }

  public CreateGenerationBody putModelParametersItem(String key, MapValue modelParametersItem) {
  ...
  public CreateGenerationBody usage(IngestionUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  public CreateGenerationBody promptName(String promptName) {
  ...
  public CreateGenerationBody promptVersion(Integer promptVersion) {
  ...
  public CreateGenerationBody endTime(OffsetDateTime endTime) {
  ...
  public CreateGenerationBody id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateGenerationBody traceId(String traceId) {
  ...
  public CreateGenerationBody name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateGenerationBody startTime(OffsetDateTime startTime) {
  ...
  public CreateGenerationBody metadata(Object metadata) {
  ...
  public CreateGenerationBody input(Object input) {
    this.input = input;
    return this;
  }
  ...
  public CreateGenerationBody output(Object output) {
    this.output = output;
    return this;
  }
  ...
  public CreateGenerationBody level(ObservationLevel level) {
    this.level = level;
    return this;
  }
  ...
  public CreateGenerationBody statusMessage(String statusMessage) {
  ...
  public CreateGenerationBody parentObservationId(String parentObservationId) {
  ...
  public CreateGenerationBody version(String version) {
   ...
   * @return the CreateGenerationBody instance itself
   */
  public CreateGenerationBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGenerationBody createGenerationBody = (CreateGenerationBody) o;
    return Objects.equals(this.completionStartTime, createGenerationBody.completionStartTime) &&
        Objects.equals(this.model, createGenerationBody.model) &&
        Objects.equals(this.modelParameters, createGenerationBody.modelParameters) &&
        Objects.equals(this.usage, createGenerationBody.usage) &&
        Objects.equals(this.promptName, createGenerationBody.promptName) &&
        Objects.equals(this.promptVersion, createGenerationBody.promptVersion) &&
        Objects.equals(this.endTime, createGenerationBody.endTime) &&
        Objects.equals(this.id, createGenerationBody.id) &&
        Objects.equals(this.traceId, createGenerationBody.traceId) &&
        Objects.equals(this.name, createGenerationBody.name) &&
        Objects.equals(this.startTime, createGenerationBody.startTime) &&
        Objects.equals(this.metadata, createGenerationBody.metadata) &&
        Objects.equals(this.input, createGenerationBody.input) &&
        Objects.equals(this.output, createGenerationBody.output) &&
        Objects.equals(this.level, createGenerationBody.level) &&
        Objects.equals(this.statusMessage, createGenerationBody.statusMessage) &&
        Objects.equals(this.parentObservationId, createGenerationBody.parentObservationId) &&
        Objects.equals(this.version, createGenerationBody.version)&&
        Objects.equals(this.additionalProperties, createGenerationBody.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGenerationBody {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGenerationBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGenerationBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGenerationBody is not found in the empty JSON string", CreateGenerationBody.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGenerationBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGenerationBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGenerationBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGenerationBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGenerationBody>() {
           @Override
           public void write(JsonWriter out, CreateGenerationBody value) throws IOException {
           ...
           @Override
           public CreateGenerationBody read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateGenerationBody instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateGenerationBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGenerationBody
   * @throws IOException if the JSON string is invalid with respect to CreateGenerationBody
   */
  public static CreateGenerationBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGenerationBody.class);
  }

  /**
   * Convert an instance of CreateGenerationBody to an JSON string
   *
   * @return JSON string
   */
